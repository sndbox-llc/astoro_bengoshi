...
<div class="card border rounded p-4 my-5 text-center">
  ...
  <div style="font-family: 'Hiragino Mincho ProN', serif; color: #3d2b1f;">
    ...
    <p class="mb-0" style="font-size: 1rem;">受付時間 午前9:00〜午後6:00</p>
  </div>
</div>
...
<div id="contactForm" class="container mt-5">
  ...
  <div class="row mb-4">
    ...
    <div class="col-md-9">
      <input type="text" id="name" class="form-control" style="width:100%;border:1px solid #ccc" />
    </div>
  </div>
  ...
  <div class="row mb-4">
    ...
    <div class="col-md-9">
      <input type="text" id="company" class="form-control" style="width:100%;border:1px solid #ccc" />
    </div>
  </div>
  ...
  <div class="row mb-4">
    ...
    <div class="col-md-9">
      <input type="text" id="addr" class="form-control"  style="width:100%;border:1px solid #ccc" />
    </div>
  </div>
  ...
  <div class="row mb-4">
    ...
    <div class="col-md-9">
      <input type="tel" id="tel" class="form-control" style="width:100%;border:1px solid #ccc" />
    </div>
  </div>
  ...
  <div class="row mb-4">
    ...
    <div class="col-md-9">
      <input type="email" id="mail" class="form-control" style="width:100%;border:1px solid #ccc"  />
    </div>
  </div>
  ...
  <div class="row mb-4">
    ...
    <div class="col-md-9">
      <textarea id="toiawasehonbun" class="form-control" rows="8" style="width:100%;border:1px solid #ccc" ></textarea>
    </div>
  </div>
