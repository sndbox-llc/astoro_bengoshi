...
<div class="card border rounded p-4 mb-5">
  <h3 class="fw-bold text-brown mb-4" >所長弁護士 亀岡 弘敬</h3>
  <h4 class="fw-bold text-brown h6" >略歴</h4>
  <ul>
  ...
  <h4 class="fw-bold text-brown h6">著作等</h4>
  <ul>
...
<!-- 中西晶子 -->
<div class="card border rounded p-4 mb-5">
  <h3 class="fw-bold text-brown mb-4">弁護士 中西 晶子</h3>
  <h4 class="fw-bold text-brown h6">略歴</h4>
  <ul>
  ...
  <h4 class="fw-bold text-brown h6">著作等</h4>
  <ul>
    <li>「願いを想いをかたちにする遺言の書き方・相続のしかた─安心・納得の遺言書作成レシピー」<br />（日本加除出版、共著）</li>
  </ul>
</div>

<!-- 渡邉拓也 -->
<div class="card border rounded p-4 mb-5">
  <h3 class="fw-bold text-brown mb-4">弁護士 渡邉 拓也</h3>
  <h4 class="fw-bold text-brown h6" >略歴</h4>
  <ul>
...
<!-- 高橋純 -->
<div class="card border rounded p-4 mb-5">
  <h3 class="fw-bold text-brown mb-4" >弁護士 高橋 純</h3>
  <h4 class="fw-bold text-brown h6" >略歴</h4>
  <ul>
